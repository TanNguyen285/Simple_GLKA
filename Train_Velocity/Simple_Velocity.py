...
# ─────────────────────────────────────────────────────────────────
#  MB_Block__Inverted Residual Block
# ─────────────────────────────────────────────────────────────────
...
class Velocity(nn.Module):
    def __init__(self, num_classes: int = 4, deploy_k: int = 13, state_dim: int = 32):
        super().__init__()
        self.app    = Shape_Block(deploy_k=deploy_k)
...
if __name__ == "__main__":
    ...
    for K in [13, 15, 19]:
        ...
        # ── SimpleNet ──
        s = GLKA_Velocity(num_classes=2, deploy_k=K).eval()
